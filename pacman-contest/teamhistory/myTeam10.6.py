...
class myAgent(CaptureAgent):
    ...
    def getFeatures(self, gameState, action):
        ...
        if min(self.getCapsuleDistance(gameState))-min(self.getCapsuleDistance(successor)) < -1 or min(self.getCapsuleDistance(gameState))-min(self.getCapsuleDistance(successor)) == 0.9:
